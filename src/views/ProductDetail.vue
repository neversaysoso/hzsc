...
const productList = {
  1: {
    ...
    sections: [
      ...
      {
        type: 'text',
        html: '<p>作为基础原料，用于制备推栈式、堆叠型等各类压电陶瓷器件，进而应用于消费电子（手机振动马达、镜头对焦模块）、工业精密设备（压电陶瓷执行器、传感器）、医疗设备（超声探头、手术刀驱动部件）、通信器件（声表面波滤波器）等领域；</p><p>高性能粉体还可用于制备压电薄膜、压电纤维等新型压电功能材料，拓展在柔性电子、微纳器件等前沿领域的应用。</p><p>我公司可根据客户产品需求和实际工况差异，定制专属的高低温粉体材料。</p><p>压电陶瓷粉体物理性能参数表：</p>',
      },
      // {
      //   type: 'image',
  ...
  5: {
    ...
    sections: [
      ...
      {
        type: 'text',
        html: '<p>1、堆叠型压电陶瓷：由多层压电陶瓷薄片与电极通过叠压、烧结工艺制成，各层间依靠外部电极连接，结构适合大行程、高精度驱动场景，重点体现长期稳定性与一致性。</p><p>2、产品优势：来料检验严格，关键工段质量管控细致，出场前经过老化验证和性能筛选，确保批次稳定、可靠运行。</p>',
      },
      {
        type: 'text',
        html: '<p>3、产品应用</p><p>堆叠型压电陶瓷：侧重大行程、高精度驱动场景，比如半导体晶圆搬运平台、航空航天精密定位机构、医疗超声手术刀驱动部件等。</p><p>高可靠性要求场景：适用于长期连续工作、环境波动较大、对寿命和稳定性要求较高的工业与精密设备。</p>',
      },
      {
        type: 'text',
        html: '<p>4、性能参数</p><p>堆叠型压电陶瓷执行器性能参数如下：</p>',
      },
      {
        type: 'image',
  ...
  9: {
    ...
    sections: [
      ...
      {
        type: 'text',
        html: '<p>波纹管密封型压电陶瓷执行器是一种高精度、高可靠性的纳米级驱动与定位装置，由高可靠性压电陶瓷与波纹管封装膜片集成构成，具备位移大、响应快、推力强、发热低、密封绝缘性好和循环寿命高等特点。</p><p>1、特点</p><p>该执行器工作温度范围为-30°C至150°C，最大输出推力可达3600N，适用于对环境洁净度和稳定性要求极高的场景。其核心优势在于通过波纹管实现完全密封，有效防止介质泄漏，同时保持优异的电绝缘性能，适合在真空、潮湿或腐蚀性环境中长期运行。</p>',
      },
      {
        type: 'text',
